package jp.cordea.camera2training.step3;
...
public class CameraActivity extends AppCompatActivity {
    ...
    @BindString(R.string.step3_text)
    String step3Text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_step3);
        ButterKnife.bind(this);

        toolbar.setTitle(String.format(Locale.getDefault(), titleFormatText, step3Text));
    ...
    private Observable<Size> getCameraSetupObservable() {
        ...
        return Observable
                ...
                .flatMap(original -> {
                    ...
                    Size max = Collections.max(Arrays.asList(original), (size, t1) ->
