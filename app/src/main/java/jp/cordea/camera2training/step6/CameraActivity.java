...
public class CameraActivity extends AppCompatActivity {
    ...
    @BindView(R.id.switch_flash_button)
    SwitchFlashButton switchFlashButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_step6);
        ...
        switchFlashButton.setOnSwitchFlashListener(this::switchFlash);
    }
        ...
        try {
            cameraDevice.createCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(@NonNull CameraCaptureSession session) {
                    ...
                    captureRequestBuilder = setFlashCaptureRequest(captureRequestBuilder, switchFlashButton.getFlashType());
    ...
    private void switchFlash(FlashType flashType) {
        captureRequestBuilder = setFlashCaptureRequest(captureRequestBuilder, flashType);
        try {
            captureSession.stopRepeating();
            captureRequest = captureRequestBuilder.build();
